                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-end gap-2">
                      <div class="m-0">
                        ...
                        <input type="text" class="form-control" id="a1" placeholder="Search By Doctors Name">
                      </div>
                      <div class="m-0">
                        <label class="form-label" for="a2">Department</label>
                        <input type="text" class="form-control" id="a2" placeholder="Search By Department">
                      </div>
                      <div class="m-0">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <a href="doctors-profile.html" class="d-flex align-items-center flex-column">
                        <img src="assets/images/user1.png" alt="Hospitals Admin Template"
                          class="img-7x rounded-circle mb-3">
                        <h5>Dr. Clive Nathan</h5>
                        <h6 class="text-truncate">Gynecologist, General Physician</h6>
              ...
              <div class="col-xxl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="text-center">
                      <a href="doctors-profile.html" class="d-flex align-items-center flex-column">
                        <img src="assets/images/user2.png" alt="Hospitals Admin Template"
                          class="img-7x rounded-circle mb-3">
              ...
              <div class="col-xxl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="text-center">
                      <a href="doctors-profile.html" class="d-flex align-items-center flex-column">
                        <img src="assets/images/user3.png" alt="Hospitals Admin Template"
                          class="img-7x rounded-circle mb-3">
              ...
              <div class="col-xxl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="text-center">
                      <a href="doctors-profile.html" class="d-flex align-items-center flex-column">
                        <img src="assets/images/user4.png" alt="Hospitals Admin Template"
                          class="img-7x rounded-circle mb-3">
                        <h5>Dr. Amelia Kim</h5>
              ...
              <div class="col-xxl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="text-center">
                      <a href="doctors-profile.html" class="d-flex align-items-center flex-column">
                        <img src="assets/images/user5.png" alt="Hospitals Admin Template"
                          class="img-7x rounded-circle mb-3">
                        <h5>Dr. Emma Monis</h5>
              ...
              <div class="col-xxl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="text-center">
                      <a href="doctors-profile.html" class="d-flex align-items-center flex-column">
                        <img src="assets/images/user.png" alt="Hospitals Admin Template"
                          class="img-7x rounded-circle mb-3">
                        <h5>Dr. Olivia</h5>
