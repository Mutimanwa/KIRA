        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-success bg-opacity-10 d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addEchoModal">
                ...
                <div class="card-body">
                    <p class="text-muted mb-4">
                        Gestion et suivi des examens échographiques.
                    </p>
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-6 col-xl-4">
                            <div class="d-flex align-items-center p-3 border rounded-3">
                                ...
                                <div>
                                    <span class="text-muted">Examens urgents</span>
                                    <h4 class="mb-0">3</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle m-0" id="basicExample">
                            ...
                            <tbody>
                                <tr>
                                    <td>Julie Dubois</td>
                                    <td>Échographie abdominale</td>
                                    <td>21/08/2025 à 11h00</td>
                                ...
                                <tr>
                                    <td>Marc Lefèvre</td>
                                    <td>Échographie pelvienne</td>
                                    <td>20/08/2025 à 15h30</td>
...
<div class="modal fade" id="addEchoModal" tabindex="-1" aria-labelledby="addEchoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEchoModalLabel">Planifier une nouvelle échographie</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="examType" class="form-label">Type d'échographie</label>
                            <select class="form-select" id="examType">
                                <option>Abdominale</option>
                                <option>Pelvienne</option>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success">Enregistrer le rendez-vous</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="imagesFile" class="form-label">Images (JPEG, PNG, etc.)</label>
