                    ...
                    <div class="row gx-3">
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="a1" value="207">
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          <label class="form-label" for="a2">Floor No</label>
                          <input type="email" class="form-control" id="a2" value="7">
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                      ...
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          ...
                          <select class="form-select" id="a4">
                            <option value="0">Gynecologist</option>
                      ...
                      <div class="col-sm-12">
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" id="a5" placeholder="Message" rows="3"></textarea>
                        </div>
                      </div>
                      <div class="col-sm-12">
                        <div class="d-flex gap-2 justify-content-end">
                          <a href="available-rooms.php" class="btn btn-outline-secondary">
                            Cancel
                          </a>
                          <a href="available-rooms.php" class="btn btn-primary">
                            Update Room Details
                          </a>
                        </div>
                      </div>
