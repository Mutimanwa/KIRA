                            ...
                            <div class="col-sm-6 col-12">
                              ...
                              <div class="mb-3">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control datepicker-opens-left" id="dueDate"
                    ...
                    <div class="row">
                        ...
                        <div class="table-outer">
                          <table class="table m-0 align-middle">
                            ...
                            <tbody>
                              ...
                              <tr class="actionRow">
                                <td>
                                  <button  id="NouvelleDepensse" class="btn btn-outline-primary text-nowrap">
                                    Add New Row
                                  </button>
                                </td>
                                <td colspan="6">
                      ...
                      <div class="col-12">
                        <div class="d-flex justify-content-end gap-2 mt-2">
                          ...
                          <a href="facturation.php" class="btn btn-success">Create Invoice</a>
                        </div>
                      </div>
                    </div>
                    <!-- Row end -->
