            ...
            <div class="card shadow-sm">
                <div class="card-header bg-secondary bg-opacity-10 d-flex justify-content-between align-items-center">
                    <h5 class="card-title text-secondary mb-0">
                        <i class="ri-radiology-line me-2"></i>
                ...
                <div class="card-body">
                    <p class="text-muted mb-4">
                        Gestion et suivi des examens de radiologie.
                    </p>
                    <div class="row g-3">
                        <div class="col-sm-6 col-md-6 col-xl-4">
                            <div class="d-flex align-items-center p-3 border rounded-3">
                                ...
                                <div>
                                    <span class="text-muted">Examens à venir (24h)</span>
                                    <h4 class="mb-0">10</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle m-0" id="basicExample">
                            ...
                            <tbody>
                                <tr>
                                    <td>A. Dupuis</td>
                                    <td>Radio du thorax</td>
                                    <td>21/08/2025 à 14h30</td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addExamModalLabel">Planifier un nouvel examen</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary">Enregistrer le rendez-vous</button>
            </div>
        </div>
    </div>
</div>
