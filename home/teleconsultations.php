    ...
    <div class="row g-4">
            ...
            <div class="card consultation-card h-100">
                <div class="card-header bg-white border-0 py-3">
                    <h3 class="card-title text-center mb-0">
                        ...
                        <span class="d-inline-block animate-typing"
                            data-text="Décrivez vos symptômes|Sélectionnez une spécialité|Préparez votre consultation"></span>
                    </h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">Décrivez l'intensité, la durée et les facteurs aggravants/soulageants
                        </div>
                    </div>
        ...
        <div class="col-lg-5">
            <div class="card consultation-chat h-100">
                <div
                    class="card-header border-bottom bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <div class="avatar-status me-3">
                            <img src="../assets/images/user2.png" class="avatar rounded-circle" width="40" height="40"
                                alt="Dr. Smith">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-sm btn-transparent rounded-circle" type="button"
                            data-bs-toggle="dropdown">
                            <i class="ri-more-2-line"></i>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#"><i class="ri-user-line me-2"></i> Profil du
                                    médecin</a></li>
                            <li><a class="dropdown-item" href="#"><i class="ri-file-text-line me-2"></i> Dossier
                                    médical</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item text-danger" href="#"><i class="ri-close-circle-line me-2"></i>
                                    Annuler la consultation</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="consultation-container">
                    ...
                    <div class="consultation-waiting text-center py-5">
                        ...
                        <p class="text-muted small mb-4 p-2 text-wrap">Votre consultation commencera automatiquement lorsque le
                            médecin sera disponible</p>
                    ...
                    <div class="consultation-active d-none" id="chatPanel">
                        <!-- Conteneur vidéo -->
                        <div class="video-container">
                            <div class="video-wrapper ratio ratio-16x9 bg-dark ">
                                <!-- Flux vidéo sera injecté ici -->
                                 <div class="video overflow-hidden">
                                    <video src="../assets/images/test.mp4"></video>
                                 </div>
                                ...
                                <div class="video-controls left-100">
                            ...
                            <div class="chat-messages" id="consultationChat">
                                ...
                                <div class="message received mb-3 ">
                                    <div class="message-sender d-flex align-items-center mb-1">
                                        <img src="../assets/images/user2.png" class="rounded-circle me-2" width="24"
                                            height="24">
                                        <small class="fw-bold">Dr. Sophie Martin</small>
                                    </div>
                                    <div class="message-content">
                                        <div class="message-text">Bonjour, nous avons un nouveau patient à l'accueil qui
                                            présente des douleurs thoraciques.</div>
                                ...
                                <div class="message sent mb-3">
                                    <div class="message-content">
                                        <div class="message-text">Merci pour l'information. Quel est le nom du patient
                                            et ses constantes ?</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="ri-information-line text-primary me-2"></i> Comment décrire ses
                    symptômes</h5>
            ...
            <div class="modal-body">
                <ul class="list-unstyled">
                    <li class="mb-3">
                        <h6 class="fw-semibold"><i class="ri-checkbox-circle-fill text-success me-2"></i> Localisation
                        </h6>
                        <p class="small text-muted">Précisez où se situe la douleur/inconfort (ex: "douleur au côté
